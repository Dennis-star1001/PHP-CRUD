    ...
    <div class="main-animal">
        ...
        <div class="output-main">
            ...
            while ($row = mysqli_fetch_array($query)) {
                ...
                echo "<tr>";
                echo "<td>{$row['id']}</td>";
                echo "<td > <b class='row'>Animal Name: </b>{$row['Name']},</td>";
                echo "<td > <b class='row'>Animal Food: </b>{$row['Food']},</td>";
                echo "<td ><b class='row'>Animal Type: </b>{$row['Type']},</td>";
                echo "<td ><b class='row'>Animal Habitat: </b> {$row['Habitat']}</td>";
