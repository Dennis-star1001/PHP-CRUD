...
if (isset($_POST['login'])) {
    ...
    if (empty($username) || empty($password)) {
        ...
        selectQuery("register", "username, password", "username = '$username' , password = $password");
    }

    $query = selectQuery("register", "username, password", "username = '$username' , password = $password");
