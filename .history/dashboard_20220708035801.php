    ...
    <div class="main-animal">
        ...
        <div class="output-main">
            ...
            while ($row = mysqli_fetch_array($query)) {
                $id = $row['id'];
                $name = $row['Name'];
                echo "<div class='output-main'>";
                echo " <div class='output'>";
                echo "<a href='animal.php?id=$id'>{$row['Name']}</a>";
                echo "</div>";
                echo "<button  class='del-btn' name='delete' type='submit'><a href='backend.php?id=$id'>Delete</a></button> ";
                echo "</div>";
                echo "<br>";
